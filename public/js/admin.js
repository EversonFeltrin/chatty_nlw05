...
socket.on ('admin_list_all_users', connections => {
    ...
    document.getElementById('list_users').innerHTML = ''; // empty para evitar que toda vez que nova conexão for inserida, ela seja duplique
...
function sendMessage(id) {
    ...
    socket.emit('admin_send_message', params); // envia pro usuário
    
    // constroi na tela do atendimento
